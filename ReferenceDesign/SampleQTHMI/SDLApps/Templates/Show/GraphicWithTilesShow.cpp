...
CGraphicWithTilesShow::CGraphicWithTilesShow(AppListInterface *pList, QWidget *parent)
    :QWidget(parent)
    ,m_pList(pList)
    ,m_btnWidth(150)
    ,m_btnHeight(150)
...
CGraphicWithTilesShow::~CGraphicWithTilesShow()
{

}

void CGraphicWithTilesShow::SoftBtnClickedSlot(int iSoftBtnID) {
    if (iSoftBtnID >= 0) {
        AppControl->OnSoftButtonClick(iSoftBtnID, BUTTON_SHORT);
    }
}

void CGraphicWithTilesShow::BtnMenuClickedSlots() {
...
void CGraphicWithTilesShow::DeleteButton(int index)
{
...
void CGraphicWithTilesShow::removeAllButton()
{
...
void CGraphicWithTilesShow::showEvent(QShowEvent *e) {
    Q_UNUSED(e);
...
void CGraphicWithTilesShow::setSoftButtons(std::vector<SSoftButton> vec_softButtons) {
