#ifndef TEXTBUTTONSWITHGRAPHICSHOW_H
#define TEXTBUTTONSWITHGRAPHICSHOW_H
...
class CTextButtonsWithGraphicShow : public QWidget {
    Q_OBJECT

public:
    explicit CTextButtonsWithGraphicShow(AppListInterface *pList, QWidget *parent = 0);
    ~CTextButtonsWithGraphicShow();
...
#endif // TEXTBUTTONSWITHGRAPHICSHOW_H
