...
CTextButtonsWithGraphicShow::CTextButtonsWithGraphicShow(AppListInterface *pList, QWidget *parent)
    :QWidget(parent)
    ,m_pList(pList)
    ,m_btnWidth(320)
    ,m_btnHeight(45)
...
CTextButtonsWithGraphicShow::~CTextButtonsWithGraphicShow()
{

}

void CTextButtonsWithGraphicShow::SoftBtnClickedSlot(int iSoftBtnID) {
    if (iSoftBtnID >= 0) {
        AppControl->OnSoftButtonClick(iSoftBtnID, BUTTON_SHORT);
    }
}

void CTextButtonsWithGraphicShow::BtnMenuClickedSlots() {
    AppControl->OnShowCommand();
}

void CTextButtonsWithGraphicShow::BtnBackClickedSlots()
{
    INFO("CTextButtonsWithGraphicShow::BtnBackClickedSlots");
    SDLApps::Inst()->GetUIManager()->onAppShow(ID_APPLINK);
}
void CTextButtonsWithGraphicShow::SetAppName(QString strName) {
    m_pTopWidget->SetTitle(strName);
}

void CTextButtonsWithGraphicShow::DeleteButton(int index)
{
...
void CTextButtonsWithGraphicShow::removeAllButton()
{
...
void CTextButtonsWithGraphicShow::showEvent(QShowEvent *e) {
    Q_UNUSED(e);
...
void CTextButtonsWithGraphicShow::setSoftButtons(std::vector<SSoftButton> vec_softButtons) {
