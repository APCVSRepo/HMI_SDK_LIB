#include "TextWithGraphicShowTest.h"
...
CTextWithGraphicShowTest::CTextWithGraphicShowTest()
{
}

void CTextWithGraphicShowTest::SetUpTestCase()
{

}

void CTextWithGraphicShowTest::TearDownTestCase()
{

}

void CTextWithGraphicShowTest::SetUp()
{

}

void CTextWithGraphicShowTest::TearDown()
{

}

TEST_F(CTextWithGraphicShowTest,OnShowCommand_Success)
{
    ...
    cTextWithGraphicShow.BtnMenuClickedSlots();
...
*/
TEST_F(CTextWithGraphicShowTest,getShowData_Success)
{
    AppListMock appListMock;
