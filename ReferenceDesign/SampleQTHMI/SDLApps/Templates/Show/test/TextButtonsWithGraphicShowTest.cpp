#include "TextButtonsWithGraphicShowTest.h"
...
CTextButtonsWithGraphicShowTest::CTextButtonsWithGraphicShowTest()
{
}

void CTextButtonsWithGraphicShowTest::SetUpTestCase()
{

}

void CTextButtonsWithGraphicShowTest::TearDownTestCase()
{

}

void CTextButtonsWithGraphicShowTest::SetUp()
{

}

void CTextButtonsWithGraphicShowTest::TearDown()
{

}


TEST_F(CTextButtonsWithGraphicShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CTextButtonsWithGraphicShow cTextButtonsWithGraphicShow(&appListMock);
    cTextButtonsWithGraphicShow.SoftBtnClickedSlot(1);

}

TEST_F(CTextButtonsWithGraphicShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CTextButtonsWithGraphicShow cTextButtonsWithGraphicShow(&appListMock);
    cTextButtonsWithGraphicShow.BtnMenuClickedSlots();

}

TEST_F(CTextButtonsWithGraphicShowTest,getShowData_Success)
{
    AppListMock appListMock;
