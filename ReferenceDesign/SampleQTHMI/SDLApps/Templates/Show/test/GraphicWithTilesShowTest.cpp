#include "GraphicWithTilesShowTest.h"
...
CGraphicWithTilesShowTest::CGraphicWithTilesShowTest()
{
}

void CGraphicWithTilesShowTest::SetUpTestCase()
{

}

void CGraphicWithTilesShowTest::TearDownTestCase()
{

}

void CGraphicWithTilesShowTest::SetUp()
{

}

void CGraphicWithTilesShowTest::TearDown()
{

}


TEST_F(CGraphicWithTilesShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CGraphicWithTilesShow cGraphicWithTilesShow(&appListMock);
    cGraphicWithTilesShow.SoftBtnClickedSlot(1);

}

TEST_F(CGraphicWithTilesShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CGraphicWithTilesShow cGraphicWithTilesShow(&appListMock);
    cGraphicWithTilesShow.BtnMenuClickedSlots();

}

TEST_F(CGraphicWithTilesShowTest,getShowData_Success)
{
    AppListMock appListMock;
