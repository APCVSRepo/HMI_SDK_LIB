#include "TilesWithGraphicShowTest.h"
...
CTilesWithGraphicShowTest::CTilesWithGraphicShowTest()
{
}

void CTilesWithGraphicShowTest::SetUpTestCase()
{

}

void CTilesWithGraphicShowTest::TearDownTestCase()
{

}

void CTilesWithGraphicShowTest::SetUp()
{

}

void CTilesWithGraphicShowTest::TearDown()
{

}


TEST_F(CTilesWithGraphicShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CTilesWithGraphicShow cTilesWithGraphicShow(&appListMock);
    cTilesWithGraphicShow.SoftBtnClickedSlot(1);

}

TEST_F(CTilesWithGraphicShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CTilesWithGraphicShow cTilesWithGraphicShow(&appListMock);
    cTilesWithGraphicShow.BtnMenuClickedSlots();

}

TEST_F(CTilesWithGraphicShowTest,getShowData_Success)
{
    AppListMock appListMock;
