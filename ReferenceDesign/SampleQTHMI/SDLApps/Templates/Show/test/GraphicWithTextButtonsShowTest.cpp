#include "GraphicWithTextButtonsShowTest.h"
...
CGraphicWithTextButtonsShowTest::CGraphicWithTextButtonsShowTest()
{
}

void CGraphicWithTextButtonsShowTest::SetUpTestCase()
{

}

void CGraphicWithTextButtonsShowTest::TearDownTestCase()
{

}

void CGraphicWithTextButtonsShowTest::SetUp()
{

}

void CGraphicWithTextButtonsShowTest::TearDown()
{

}


TEST_F(CGraphicWithTextButtonsShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CGraphicWithTextButtonsShow cGraphicWithTextButtonsShow(&appListMock);
    cGraphicWithTextButtonsShow.SoftBtnClickedSlot(1);

}

TEST_F(CGraphicWithTextButtonsShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CGraphicWithTextButtonsShow cGraphicWithTextButtonsShow(&appListMock);
    cGraphicWithTextButtonsShow.BtnMenuClickedSlots();

}

TEST_F(CGraphicWithTextButtonsShowTest,getShowData_Success)
{
    AppListMock appListMock;
