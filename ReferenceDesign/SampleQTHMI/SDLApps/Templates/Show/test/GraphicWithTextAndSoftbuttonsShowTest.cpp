#include "GraphicWithTextAndSoftbuttonsShowTest.h"
...
CGraphicWithTextAndSoftbuttonsShowTest::CGraphicWithTextAndSoftbuttonsShowTest()
{
}

void CGraphicWithTextAndSoftbuttonsShowTest::SetUpTestCase()
{

}

void CGraphicWithTextAndSoftbuttonsShowTest::TearDownTestCase()
{

}

void CGraphicWithTextAndSoftbuttonsShowTest::SetUp()
{

}

void CGraphicWithTextAndSoftbuttonsShowTest::TearDown()
{

}


TEST_F(CGraphicWithTextAndSoftbuttonsShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CGraphicWithTextAndSoftbuttonsShow cGraphicWithTextAndSoftbuttonsShow(&appListMock);
    cGraphicWithTextAndSoftbuttonsShow.SoftBtnClickedSlot(1);

}

TEST_F(CGraphicWithTextAndSoftbuttonsShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CGraphicWithTextAndSoftbuttonsShow cGraphicWithTextAndSoftbuttonsShow(&appListMock);
    cGraphicWithTextAndSoftbuttonsShow.BtnMenuClickedSlots();

}

TEST_F(CGraphicWithTextAndSoftbuttonsShowTest,getShowData_Success)
{
    AppListMock appListMock;
