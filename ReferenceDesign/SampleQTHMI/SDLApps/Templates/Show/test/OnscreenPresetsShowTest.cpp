#include "OnscreenPresetsShowTest.h"
...
COnscreenPresetsShowTest::COnscreenPresetsShowTest()
{
}

void COnscreenPresetsShowTest::SetUpTestCase()
{

}

void COnscreenPresetsShowTest::TearDownTestCase()
{

}

void COnscreenPresetsShowTest::SetUp()
{

}

void COnscreenPresetsShowTest::TearDown()
{

}


TEST_F(COnscreenPresetsShowTest,OnSoftButtonClick_Success)
{
    ...
    COnscreenPresetsShow cOnscreenPresetsShow(&appListMock);
    cOnscreenPresetsShow.SoftBtnClickedSlot(1);
}

TEST_F(COnscreenPresetsShowTest,OnShowCommand_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    ...
    COnscreenPresetsShow cOnscreenPresetsShow(&appListMock);
    cOnscreenPresetsShow.BtnMenuClickedSlots();

}



TEST_F(COnscreenPresetsShowTest,getMediaClockJson_Success)
{
    AppListMock appListMock;
...
TEST_F(COnscreenPresetsShowTest,OnSetMediaClockTimerResponse_COUNTUP_Success)
{
    AppListMock appListMock;
    UIInterfaceMock uiManagerMock;
    ...
    COnscreenPresetsShow cOnscreenPresetsShow(&appListMock);
    cOnscreenPresetsShow.UpdateMediaClockTimer();
}


TEST_F(COnscreenPresetsShowTest,OnSetMediaClockTimerResponse_COUNTDOWN_Success)
{
    AppListMock appListMock;
    UIInterfaceMock uiManagerMock;
...
TEST_F(COnscreenPresetsShowTest,OnSetMediaClockTimerResponse_PAUSE_Success)
{
    AppListMock appListMock;
    UIInterfaceMock uiManagerMock;
...
TEST_F(COnscreenPresetsShowTest,OnSetMediaClockTimerResponse_RESUME_Success)
{
    AppListMock appListMock;
    UIInterfaceMock uiManagerMock;
...
TEST_F(COnscreenPresetsShowTest,OnSetMediaClockTimerResponse_CLEAR_Success)
{
    AppListMock appListMock;
    UIInterfaceMock uiManagerMock;
