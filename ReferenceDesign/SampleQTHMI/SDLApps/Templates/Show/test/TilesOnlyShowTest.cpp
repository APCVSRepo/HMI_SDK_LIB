...
CTilesOnlyShowTest::CTilesOnlyShowTest()
{
}

void CTilesOnlyShowTest::SetUpTestCase()
{

}

void CTilesOnlyShowTest::TearDownTestCase()
{

}

void CTilesOnlyShowTest::SetUp()
{

}

void CTilesOnlyShowTest::TearDown()
{

}


TEST_F(CTilesOnlyShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CTilesOnlyShow cTilesOnlyShow(&appListMock);
    cTilesOnlyShow.SoftBtnClickedSlot(1);

}

TEST_F(CTilesOnlyShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CTilesOnlyShow cTilesOnlyShow(&appListMock);
    cTilesOnlyShow.BtnMenuClickedSlots();

}

TEST_F(CTilesOnlyShowTest,getShowData_Success)
{
    AppListMock appListMock;
