#include "TextButtonsOnlyShowTest.h"
...
CTextButtonsOnlyShowTest::CTextButtonsOnlyShowTest()
{
}

void CTextButtonsOnlyShowTest::SetUpTestCase()
{

}

void CTextButtonsOnlyShowTest::TearDownTestCase()
{

}

void CTextButtonsOnlyShowTest::SetUp()
{

}

void CTextButtonsOnlyShowTest::TearDown()
{

}


TEST_F(CTextButtonsOnlyShowTest,SoftBtnClickedSlot_Success)
{
    ...
    CTextButtonsOnlyShow cTextButtonsOnlyShow(&appListMock);
    cTextButtonsOnlyShow.SoftBtnClickedSlot(1);

}

TEST_F(CTextButtonsOnlyShowTest,BtnMenuClickedSlots_Success)
{
    AppListMock appListMock;
    AppDataMock appDataMock;
    appListMock.DelegateGetActiveApp();
    ...
    CTextButtonsOnlyShow cTextButtonsOnlyShow(&appListMock);
    cTextButtonsOnlyShow.BtnMenuClickedSlots();

}

TEST_F(CTextButtonsOnlyShowTest,getShowData_Success)
{
    AppListMock appListMock;
