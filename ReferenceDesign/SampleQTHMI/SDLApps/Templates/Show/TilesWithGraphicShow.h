#ifndef TILESWITHGRAPHICSHOW_H
#define TILESWITHGRAPHICSHOW_H
...
class CTilesWithGraphicShow : public QWidget {
    Q_OBJECT

public:
    explicit CTilesWithGraphicShow(AppListInterface *pList, QWidget *parent = 0);
    ~CTilesWithGraphicShow();
