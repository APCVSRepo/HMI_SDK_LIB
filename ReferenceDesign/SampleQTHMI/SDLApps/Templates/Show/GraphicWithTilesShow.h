#ifndef GRAPHICWITHTILESSHOW_H
#define GRAPHICWITHTILESSHOW_H
...
class CGraphicWithTilesShow : public QWidget {
    Q_OBJECT

public:
    explicit CGraphicWithTilesShow(AppListInterface *pList, QWidget *parent = 0);
    ~CGraphicWithTilesShow();
