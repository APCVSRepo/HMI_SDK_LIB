#ifndef ONSCREENPRESETSSHOW_H
#define ONSCREENPRESETSSHOW_H
...
class COnscreenPresetsShow : public QWidget {
    Q_OBJECT

public:
    explicit COnscreenPresetsShow(AppListInterface *pList, QWidget *parent = 0);
    ~COnscreenPresetsShow();
