...
CGraphicWithTextAndSoftbuttonsShow::CGraphicWithTextAndSoftbuttonsShow(AppListInterface *pList, QWidget *parent)
    :QWidget(parent)
    ,m_pList(pList)
    ,m_btnWidth(150)
    ,m_btnHeight(150)
    ...
    ,m_pTopWidget(NULL)
{
    ...
    m_aShowLine[0].setGeometry(427,75,317,60);
    ...
    m_aShowLine[1].setGeometry(427,135,317,60);
    ...
    m_aShowLine[2].setGeometry(427,195,317,60);
    m_aShowLine[2].setAlignment(Qt::AlignLeft|Qt::AlignVCenter);
}

CGraphicWithTextAndSoftbuttonsShow::~CGraphicWithTextAndSoftbuttonsShow()
{

}

void CGraphicWithTextAndSoftbuttonsShow::SoftBtnClickedSlot(int iSoftBtnID) {
    if (iSoftBtnID >= 0) {
        AppControl->OnSoftButtonClick(iSoftBtnID, BUTTON_SHORT);
    }
}

void CGraphicWithTextAndSoftbuttonsShow::BtnMenuClickedSlots() {
    AppControl->OnShowCommand();
}

void CGraphicWithTextAndSoftbuttonsShow::BtnBackClickedSlots()
{
    INFO("CGraphicWithTextAndSoftbuttonsShow::BtnBackClickedSlots");
...
void CGraphicWithTextAndSoftbuttonsShow::SetAppName(QString strName) {
    m_pTopWidget->SetTitle(strName);
}

void CGraphicWithTextAndSoftbuttonsShow::DeleteButton(int index)
{
...
void CGraphicWithTextAndSoftbuttonsShow::removeAllButton()
{
...
void CGraphicWithTextAndSoftbuttonsShow::showEvent(QShowEvent *e) {
    Q_UNUSED(e);
...
void CGraphicWithTextAndSoftbuttonsShow::setSoftButtons(std::vector<SSoftButton> vec_softButtons) {
