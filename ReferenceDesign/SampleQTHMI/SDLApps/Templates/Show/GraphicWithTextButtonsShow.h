#ifndef GRAPHICWITHTEXTBUTTONSSHOW_H
#define GRAPHICWITHTEXTBUTTONSSHOW_H
...
class CGraphicWithTextButtonsShow : public QWidget {
    Q_OBJECT

public:
    explicit CGraphicWithTextButtonsShow(AppListInterface *pList, QWidget *parent = 0);
    ~CGraphicWithTextButtonsShow();
...
#endif // GRAPHICWITHTEXTBUTTONSSHOW_H
