#ifndef GRAPHICWITHTEXTANDSOFTBUTTONSSHOW_H
#define GRAPHICWITHTEXTANDSOFTBUTTONSSHOW_H
...
class CGraphicWithTextAndSoftbuttonsShow : public QWidget {
    Q_OBJECT

public:
    explicit CGraphicWithTextAndSoftbuttonsShow(AppListInterface *pList, QWidget *parent = 0);
    ~CGraphicWithTextAndSoftbuttonsShow();
...
#endif // GRAPHICWITHTEXTANDSOFTBUTTONSSHOW_H
