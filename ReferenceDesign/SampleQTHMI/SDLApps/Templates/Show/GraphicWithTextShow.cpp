...
CGraphicWithTextShow::CGraphicWithTextShow(AppListInterface *pList, QWidget *parent)
    :QWidget(parent)
    ,m_pList(pList)
    ,m_pTopWidget(NULL)
    ,m_pFrameLab(NULL)
...
void CGraphicWithTextShow::BtnMenuClickedSlots() {
...
void CGraphicWithTextShow::SetAppName(QString strName) {
    m_pTopWidget->SetTitle(strName);
}

void CGraphicWithTextShow::showEvent(QShowEvent *e) {
    Q_UNUSED(e);
