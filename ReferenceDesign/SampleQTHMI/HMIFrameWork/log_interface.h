...
#else
#define INFO(format,...) qDebug("[INFO]-File: " __FILE__ ", Line: %05d: " format, __LINE__, ##__VA_ARGS__)
#define ERROR(format,...) qDebug("[INFO]-File: " __FILE__ ", Line: %05d: " format, __LINE__, ##__VA_ARGS__)
#define WARN(format,...) qDebug("[INFO]-File: " __FILE__ ", Line: %05d: " format, __LINE__, ##__VA_ARGS__)
#endif
